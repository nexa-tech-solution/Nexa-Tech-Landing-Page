...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const mailtoLink = `mailto:cs.nexatech@gmail.com?subject=${encodeURIComponent(
      subject as string
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <Card className="bg-card border-border p-6 shadow-xl">
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-6 shadow-md"
                >
